...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var caseData = {
    "ecommerce-1": { title: "花西子护肤品视觉项目", desc: "AI 生成背景 人工精修 转化率提升 40", deliverables: ecommerceDeliverables },
    "ecommerce-2": { title: "小米 3C 数码详情页项目", desc: "15 板块完整设计 点击率提升 60", deliverables: ecommerceDeliverables },
    "ecommerce-3": { title: "UR 女装品牌店铺装修项目", desc: "首页 活动页 品牌 VI 统一输出", deliverables: ecommerceDeliverables },
    "ecommerce-4": { title: "三只松鼠零食视觉项目", desc: "主图 详情页 活动海报统一输出", deliverables: ecommerceDeliverables },
    "ecommerce-5": { title: "源氏木语家居展示项目", desc: "场景合成 去背景 批量精修 200 张", deliverables: ecommerceDeliverables },
    "ecommerce-6": { title: "babycare 母婴用品视觉项目", desc: "温馨 ins 风 多 SKU 统一视觉风格", deliverables: ecommerceDeliverables },
    "ecommerce-7": { title: "迪卡侬运动装备视觉项目", desc: "卖点可视化 场景渲染 功能演示图", deliverables: ecommerceDeliverables },
    "ecommerce-8": { title: "顽皮宠物食品品牌项目", desc: "IP 形象设计 产品包装 详情页一体化", deliverables: ecommerceDeliverables },
    "video-1": { title: "完美日记品牌宣传片项目", desc: "30 秒产品展示 卖点可视化 多平台适配", deliverables: videoBrand },
    "video-2": { title: "良品铺子信息流广告项目", desc: "多版本 AB 测试 高转化素材制作", deliverables: videoFeed },
    "video-3": { title: "大疆 3C 开箱视频项目", desc: "AI 生成脚本加剪辑 产品展示与教程", deliverables: videoShort },
    "video-4": { title: "优衣库女装穿搭视频项目", desc: "多套搭配展示 场景切换 节奏感剪辑", deliverables: videoShort },
    "video-5": { title: "美的家电演示视频项目", desc: "功能演示 场景还原 对比效果展示", deliverables: videoProduct },
    "video-6": { title: "安踏运动品牌广告片项目", desc: "动感剪辑 高燃配乐 多场景切换", deliverables: videoProduct },
    "video-7": { title: " pidan 宠物用品视频项目", desc: "15 秒产品展示 使用演示 萌宠出镜", deliverables: videoShort },
    "video-8": { title: "比亚迪企业宣传片项目", desc: "企业形象展示 团队介绍 文化输出", deliverables: videoBrand },
    "social-1": { title: "花知晓小红书运营项目", desc: "3 个月粉丝增长 5 万 爆文 12 篇", deliverables: socialXHS },
    "social-2": { title: "汤臣倍健公众号代运营项目", desc: "每周 3 篇深度文章 平均阅读量 5000", deliverables: socialWX },
    "social-3": { title: "Babycare 全平台内容项目", desc: "公众号 小红书 抖音同步运营", deliverables: socialContent },
    "social-4": { title: "CHARLES & KEITH 种草运营项目", desc: "穿搭种草笔记 单篇阅读 10 万", deliverables: socialXHS },
    "social-5": { title: "大众点评美食内容项目", desc: "测评种草 探店内容 粉丝互动活动", deliverables: socialContent },
    "social-6": { title: "造作家居内容运营项目", desc: "好物推荐内容 种草转化 月度数据复盘", deliverables: socialWX },
    "social-7": { title: "Keep 健身社交运营项目", desc: "运动干货 打卡活动 社群用户维护", deliverables: socialFans },
    "social-8": { title: "Kimi 宠物 IP 账号项目", desc: "萌宠人设打造 日常内容 粉丝增长 5 万", deliverables: socialFans },
    "ai-1": { title: "得物电商团队 AI 工作流项目", desc: "选品到上架全流程自动化 效率提升 3 倍", deliverables: aiWorkflow },
    "ai-2": { title: "海尔企业 AI 培训项目", desc: "20 人团队培训 全员 AI 工具实操", deliverables: aiTrain },
    "ai-3": { title: "蔚来企业 AI 定制项目", desc: "业务场景深度分析 原型开发与测试", deliverables: aiCustom },
    "ai-4": { title: "顺丰智能客服系统项目", desc: "响应时间缩短 70 人力成本降低 50", deliverables: aiTools },
    "ai-5": { title: "新氧文案团队 AI 落地项目", desc: "内容生产效率翻倍 AI 工具全流程部署", deliverables: aiTools },
    "ai-6": { title: "永辉电商数据 AI 分析项目", desc: "销售预测 用户画像 AI 自动报表", deliverables: aiCustom },
    "ai-7": { title: "江南布衣设计团队 AI 项目", desc: "AI 辅助设计 批量出图 效率提升 5 倍", deliverables: aiTools },
    "ai-8": { title: "欧莱雅营销团队 AI 项目", desc: "智能投放 内容生成 用户画像精准营销", deliverables: aiWorkflow }
  };
